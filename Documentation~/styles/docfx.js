...
$(function () {
  ...
  renderAffix();
  renderFooter();
  //note: we don't replace the logo svg with it's inline equivalent for the static site 
  //with the rendertoc() function because it requires http which is restricted by CORS.
  collapsibleSections();
